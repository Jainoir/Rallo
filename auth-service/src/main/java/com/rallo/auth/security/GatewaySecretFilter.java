 ...
 * stamps forwarded requests with a shared secret; enforcing it here keeps
 * this service unreachable directly even when the platform gives it a
 * public URL (e.g. Render free tier). Disabled when no secret is
